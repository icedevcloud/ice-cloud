...
public class Swagger2Config {
    ...
    public Docket createRestApi() {
        return new Docket(DocumentationType.SWAGGER_2)
                ...
                .select()
                .apis(RequestHandlerSelectors.basePackage("com.xiaobingby.upms.controller")) // 指定controller存放的目录路径
    ...
    private ApiInfo apiInfo() {
        return new ApiInfoBuilder()
                .title("bing-upms API服务") // 文档标题
                .description("bing-upms PI接口文档简要描述") // 文档描述
