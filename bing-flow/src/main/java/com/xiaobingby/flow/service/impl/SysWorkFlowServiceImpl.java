...
public class SysWorkFlowServiceImpl extends ServiceImpl<SysWorkFlowMapper, SysWorkFlow> implements ISysWorkFlowService {
    ...
    private MultiInstanceLoopCharacteristics createMultiInstanceLoopCharacteristics(boolean sequential,String loopCardinality,
                                                                                   String CollectionString,String completionCondition,String elementVariable){
        ...
        //multiInstanceLoopCharacteristics.setExtensionElements(Maps.newHashMap());
        //multiInstanceLoopCharacteristics.setAttributes(Maps.newHashMap());
        //multiInstanceLoopCharacteristics.setValues(new BaseElement());
